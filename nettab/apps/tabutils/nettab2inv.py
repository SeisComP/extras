...
from seiscomp.legacy.db.seiscomp3.routing import Routing as SC3Routing
from seiscomp.legacy.db.seiscomp3.inventory import Inventory as SC3Inventory
from nettab.nettab import Nettab, Instruments, NettabError, _EPOCH_DATE
import seiscomp.core, seiscomp.client, seiscomp.datamodel, seiscomp.logging, seiscomp.config, seiscomp.system, seiscomp.io
from seiscomp.helpers import writeobj

VERSION = "0.1 (2012.143)"

class SyncNettab(seiscomp.client.Application):
    ...
    def validateParameters(self):
        try:
            ...
            if len(opts) < 1:
                self.input_dir = os.path.join(seiscomp.system.Environment.Instance().appConfigDir(), "nettab");
            else:
    ...
    def initConfiguration(self):
        ...
        except seiscomp.config.Exception:
            pass
